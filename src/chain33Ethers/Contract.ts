...
function buildCall(contract: Contract, fragment: FunctionFragment, collapseSimple: boolean): ContractFunction {
    ...
    return async function(...args: Array<any>): Promise<any> {
        ...
        console.log('contract:',contract,'fragment:',fragment,'collapseSimple:',collapseSimple);
...
//: Promise<Contract> 
    ...
    static getContract(address: string, contractInterface: ContractInterface, provider?: BtyProvider): Contract {
